...
get "/portfolio" do
  ...
  @portfolio = [
    ...
    {:name => "Angry Natives", :date => "02/07", :kind => :website, :role => "Designer and Developer", :skills => "Design, XHTML and CSS"},
    {:name => "Gavin Stenhouse", :date => "01/07", :kind => :website, :role => "Designer and Developer", :skills => "Design, XHTML and CSS"},
    ...
    {:name => "Nykris Training ", :date => "11/03 ", :kind => :training, :role => "Trainer ", :skills => "Training, CSS, XHTML, Accessibility"},
